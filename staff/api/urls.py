...
urlpatterns = [
    ...
    path('attendance/statistical',views.get_attendance_by_month,name='all_attendance'),
    ...
    path('attendance/<str:staff_id>/update',views.update_time_out,name='update_attendance'),
    path('attendance/<str:staff_id>/delete',views.delete_attend,name='delete_attendance'),
    path('attendance/<str:staff_id>/statistical',views.get_attend_statistical,name='detail_attendance'),
